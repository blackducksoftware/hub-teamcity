...
public class HubProxyInfo implements Serializable {
    ...
    public HubProxyInfo(String host, Integer port, List<Pattern> noProxyHostsPatterns, String proxyUsername, String proxyPassword) {
        this.host = host;
        this.port = port;
    ...
    public String toString() {
        return "CCProxyInfo [host=" + host + ", port=" + port + ", proxyUsername=" + proxyUsername + ", proxyPassword=" + proxyPassword
                + ", ignoredProxyHosts=" + ignoredProxyHosts + "]";
    }
