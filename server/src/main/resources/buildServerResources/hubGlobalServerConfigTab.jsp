	...
	<h3>Hub Settings</h3>
        <table border="0" style="width: 100%">
            <tr>
                <td width="200px" >
                    <label class="label" for="hubUrl">Server URL:
                        ...
                        <bs:helpIcon
                                iconTitle="Specify the URL of your Hub installation, for example: http://hub.blackducksoftware"/>
                    </label>
                </td>
                <td>
                    <forms:textField className="textFieldLong" name="hubUrl" id="hubUrl" value=""/>
                </td>
            </tr>
            <tr>
                <td colspan="2">
            ...
            <tr>
                <td width="200px" >
                    ...
                    <span class="mandatoryAsterix" title="Mandatory field">*</span>
                        <bs:helpIcon
                                iconTitle="Hub user name."/>
                    </label>
                </td>
                <td>
                    <forms:textField className="textFieldLong" name="hubUser" id="hubUser" value=""/>
                </td>
            </tr>
             <tr>
                <td colspan="2">
        ...
        <table border="0" style="width: 100%">
        	<tr>
                ...
                <td>
                    <forms:textField className="textFieldLong" name="hubProxyServer" id="hubProxyServer" value=""/>
                </td>
            </tr>
            <tr>
                <td colspan="2">
            ...
            <tr>
                <td width="200px" >
                    <label class="label" for="hubProxyPort">Proxy Port:
                        <bs:helpIcon
                                iconTitle="The port to be used to connect to the Proxy Server"/>
                    </label>
                </td>
                <td>
                    <forms:textField className="textFieldLong" name="hubProxyPort" id="hubProxyPort" value=""/>
                </td>
            </tr>
             <tr>
                <td colspan="2">
            ...
            <tr>
                <td width="200px" >
                    <label class="label" for="hubNoProxyHost">No Proxy Host Names:
                        <bs:helpIcon
                                iconTitle="Specify host name regular expression patterns that shouldn't go through the proxy, in a comma separated list. Ex. .*blackducksoftware.com.*"/>
                    </label>
                </td>
                <td>
            ...
            <tr>
					<td width="200px"><label class="label" for="hubProxyUser">
							Proxy Username: <bs:helpIcon
								iconTitle="The username to use in the Proxy authentication. We currently only support proxies with Basic authenticaiton or no authentication." />
					</label></td>
					<td><forms:textField className="textFieldLong"
				...
				<tr>
					<td width="200px"><label class="label" for="hubProxyPass">
							Proxy Password: <bs:helpIcon
								iconTitle="The password to use in the Proxy authentication. We currently only support proxies with Basic authenticaiton or no authentication." />
					</label></td>
